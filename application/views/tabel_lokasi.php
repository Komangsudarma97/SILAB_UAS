 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Tabel Lokasi</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Data Tabel Lokasi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <p class="card-body">
										<button style="float: right;" type="submit" class="btn btn-outline-primary">
												<i class="fas fa-plus">
												<a href="<?=site_url('Silab/register_lokasi')?>">
												Tambah Data
												</i>
												</a>
										</button>
                ...
                <tr>
                      ...
                      foreach($id_lokasi as $val){?>
                          ...
                          <td><?php echo $no++ ?></td>
													...
													<td><?=$val['nama_lab'];?></td>
													<td>
                          <a href="<?=site_url('Silab/update_register_lokasi/'.md5($val['id_lokasi']))?>"><i class="fas fa-pencil-alt"></i></a>
													<a href="<?=site_url('Silab/delete_lokasi/'.($val['id_lokasi']));?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');"><i class="fas fa-eraser"></i></a>
                          </td>
												</tr>
											<?php } ?>
											<tbody>
