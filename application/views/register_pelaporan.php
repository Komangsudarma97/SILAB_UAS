      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/register_user');?>" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/daftar_pelaporan');?>" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Master Pelaporan
              </p>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Input Data Pelaporan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Input Data Pelaporan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?=site_url('Silab/save_register_pelaporan');?>"  method="POST">
			  <input type="hidden" name="id_pelaporan" value="<?=(isset($id_pelaporan['id_pelaporan']))?md5($id_pelaporan['id_pelaporan']):'';?>">
                <div class="card-body">
                <div class="form-group">
                <label for="inputStatus">Nama User</label>
                ...
                <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tgl_lapor" class="form-control" id="tgl_lapor" placeholder="Masukan Tanggal" value="<?=(isset($id_pelaporan['tgl_lapor']))?($id_pelaporan['tgl_lapor']):'';?>" />
                  </div>
                  <div class="form-group">
                <label for="inputStatus">Nama Barang</label>
                <select class="form-control custom-select" name="kode_aset">
                <?php
					foreach($nama_barang as $val){?>
                <option value="<?=$val['kode_aset'];?>"><?=$val['nama_barang'];?></option>
                <?php } ?>
                </select>
              </div>
          <div class="form-group">
                <label for="deskripsi_laporan">Deskripsi Laporan</label>
                <textarea id="deskripsi_laporan" name="deskripsi_laporan" class="form-control" rows="4" value="<?=(isset($id_pelaporan['deskripsi_laporan']))?($id_pelaporan['deskripsi_laporan']):'';?>"></textarea>
              </div>
                  <div class="form-group">
                    <label for="status">Status</label>
                    <input type="text" name="status" class="form-control" id="status" placeholder="Masukan Status" value="<?=(isset($id_pelaporan['status']))?($id_pelaporan['status']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="tanggapan">Tanggapan</label>
                    <input type="text" name="tanggapan" class="form-control" id="tanggapan" placeholder="Masukan Tanggapan" value="<?=(isset($id_pelaporan['tangapan']))?($id_pelaporan['tangapan']):'';?>" />
                  </div>
                </div>
                <!-- /.card-body -->
