    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/register_prodi');?>" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Master Prodi
              </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Input Data Prodi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?=site_url('Silab/save_register_prodi');?>"  method="POST">
			  <input type="hidden" name="id_prodi" value="<?=(isset($id_prodi['id_prodi']))?md5($id_prodi['id_prodi']):'';?>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="jurusan" class="form-control" id="jurusan" placeholder="Masukan Jurusan" value="<?=(isset($id_prodi['jurusan']))?($id_prodi['jurusan']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="fakultas">Fakultas</label>
                    <input type="text" name="fakultas" class="form-control" id="fakultas" placeholder="Masukan Fakultas" value="<?=(isset($id_prodi['fakultas']))?($id_prodi['fakultas']):'';?>" />
                  </div>
                </div>
                <!-- /.card-body -->
