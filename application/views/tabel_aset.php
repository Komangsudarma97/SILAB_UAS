 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Tabel Aset</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Data Tabel Aset</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="card">
            ...
            <p class="card-body">
										<button style="float: right;" type="submit" class="btn btn-outline-primary">
												<i class="fas fa-plus">
												<a href="<?=site_url('Silab/register_aset')?>">
												Tambah Data
												</i>
												</a>
										</button>
                      ...
                      <?php
                        ...
                        foreach($kode_aset as $val){?>
                          ...
                          <td><img width='130' src="<?=base_url('media/images/' .$val['foto']);?>"></td>
													<td>
                          <a href="<?=site_url('Silab/update_register_aset/'.md5($val['kode_aset']))?>"><i class="fas fa-pencil-alt"></i></a>
													<a href="<?=site_url('Silab/delete_aset/'.($val['kode_aset']));?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');"><i class="fas fa-eraser"></i></a>
                          </td>
												</tr>
											<?php } ?>
											<tbody>
