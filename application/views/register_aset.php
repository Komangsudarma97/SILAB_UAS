    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/daftar_aset');?>" class="nav-link active">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Input Data Aset</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Input Data Aset</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?=site_url('Silab/save_register_aset');?>"  method="POST" enctype="multipart/form-data">
			        <input type="hidden" name="kode_aset" value="<?=(isset($kode_aset['kode_aset']))?md5($kode_aset['kode_aset']):'';?>">
                  <div class="card-body">
                  <div class="form-group">
                  <label for="inputStatus">Nama Lokasi</label>
                ...
                <?php } ?>
                    ...
                    <input type="text" name="nama_barang" class="form-control" id="nama_barang" placeholder="Masukan Nama Barang" value="<?=(isset($kode_aset['nama_barang']))?($kode_aset['nama_barang']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="spesifikasi">Spesifikasi</label>
                    <input type="text" name="spesifikasi" class="form-control" id="spesifikasi" placeholder="Masukan Spesifikasi" value="<?=(isset($kode_aset['spesifikasi']))?($kode_aset['spesifikasi']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="jumlah">Jumlah</label>
                    <input type="text" name="jumlah" class="form-control" id="jumlah" placeholder="Masukan Jumlah" value="<?=(isset($kode_aset['jumlah']))?($kode_aset['jumlah']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="satuan">Satuan</label>
                    <input type="text" name="satuan" class="form-control" id="satuan" placeholder="Masukan Satuan" value="<?=(isset($kode_aset['satuan']))?($kode_aset['satuan']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="keterangan">Keterangan</label>
                    <input type="text" name="keterangan" class="form-control" id="keterangan" placeholder="Masukan Keterangan" value="<?=(isset($kode_aset['keterangan']))?($kode_aset['keterangan']):'';?>" />
                  </div>
                  <div class="form-group">
                    <label for="foto">Foto</label>
                    <input type="file" name="foto" class="form-control" id="foto" placeholder="Masukan Foto" value="<?=(isset($kode_aset['foto']))?($kode_aset['foto']):'';?>" />
                  </div>
                </div>
                <!-- /.card-body -->
