      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/daftar_user');?>" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Tabel User</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <p class="card-body">
				<button style="float: right;" type="submit" class="btn btn-outline-primary">
					<i class="fas fa-plus">
					<a href="<?=site_url('Silab/register_user')?>">
					Tambah Data
					</i>
					</a>
					</button>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                      ...
                      foreach($id_user as $val){?>
                          ...
                          <td><?=$val['jabatan'];?></td>
						  <td>
              <a href="<?=site_url('Silab/update_register_user/'.md5($val['id_user']))?>"><i class="fas fa-pencil-alt"></i></a>
						  <a href="<?=site_url('Silab/delete_user/'.($val['id_user']));?>"onclick="return confirm('Anda yakin akan menghapus data ini ?');"><i class="fas fa-eraser"></i></a>
              </td>
						</tr>
						<?php } ?>
						<tbody>
