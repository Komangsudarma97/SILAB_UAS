...
<head>
  ...
  <title>Sistem Informasi Inventaris Lab | Log In </title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>SISTEM <br> INVENTARIS LAB</br></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
    <img src="<?=base_url();?>/dist/img/logo.png" width="200px" height="200px" style="display: block; margin: auto;"/>
