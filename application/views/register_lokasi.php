    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?=site_url('Silab/daftar_lokasi');?>" class="nav-link active">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Master Lokasi
              </p>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?=site_url('Silab/save_register_lokasi');?>"  method="POST">
			  <input type="hidden" name="id_lokasi" value="<?=(isset($id_lokasi['id_lokasi']))?md5($id_lokasi['id_lokasi']):'';?>">
                <div class="card-body">
                <div class="form-group">
					<label class="col-lg-3">Nama Prodi</label>
					<div class="col-lg-9">
					<select class="form-control custom-select" name="id_prodi">
							<?php
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="nama_lab">Nama Lab</label>
                    <div class="col-lg-9">
                    <input type="text" name="nama_lab" class="form-control" id="nama_lab" placeholder="Masukan Nama Lab" value="<?=(isset($id_lokasi['nama_lab']))?($id_lokasi['nama_lab']):'';?>" />
                  </div>
                <!-- /.card-body -->
