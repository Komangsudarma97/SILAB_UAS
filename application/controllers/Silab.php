...
class Silab extends CI_Controller{
    ...
    function daftar_lokasi($page=0){
        ...
        $this->load->view('tabel_lokasi', $data);
    }
    function register_lokasi(){
        ...
        $this->load->view('register_lokasi',$data);
    }
    ...
    function daftar_pelaporan($page=0){
        ...
        $this->load->view('tabel_pelaporan', $data);
    }
    function register_pelaporan(){
        $data['title']="Registrasi";
        $data['metta']="Ini adalah produk untuk latihan HTML";
        $data['content']='register_pelaporan';
        $data['nama']=$this->M_silab->get_pelaporan2();
        $data['nama_barang']=$this->M_silab->get_pelaporan3();
        $this->load->view('register_pelaporan',$data);
    }
    ...
    public function search_pelaporan(){ //search pelaporan
        $keyword = $this->input->post('keyword');
    ...
    function daftar_aset($page=0){
        ...
        $this->load->view('tabel_aset', $data);
    }
    function register_aset(){
        ...
        $this->load->view('register_aset',$data);
    }
    ...
    function daftar_prodi($page=0){
        ...
        $this->load->view('tabel_prodi', $data);
    }
    function register_prodi(){
        $data['title']="Registrasi";
        $data['metta']="Ini adalah produk untuk latihan HTML";
        $data['content']='register_prodi';
        $this->load->view('register_prodi',$data);
    }
    ...
    public function search_prodi(){ //search prodi
        $keyword = $this->input->post('keyword');
        $data['id_prodi']=$this->M_silab->get_data_prodi_keyword($keyword);
        $data['beranda']="tabel_prodi";
        $this->load->view('tabel_prodi',$data);
    }
